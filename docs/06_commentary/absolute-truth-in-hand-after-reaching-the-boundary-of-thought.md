...
\begin{aligned}
\text{根部确定性：}
&\quad U_*\mid\mathrm{PR};\\
\text{生成开放性：}
&\quad
\{\mathrm{RULE}_i,\mathrm{Chaos}_i,\mathrm{World}_i,\mathrm{Life}_i,\mathrm{Mind}_i\}_{i\in I}.
\end{aligned}
$$
...
- [贾宝龙绝对真理](../01_foundation/03_JIABAOLONG_ABSOLUTE_TRUTH.md)
- [贾宝龙公理体系](../01_foundation/02_JIABAOLONG_AXIOM_SYSTEM.md)
- [宇宙第一拍为什么必须是 PR：七重论证](../02_first_beat/04_FIRST_BEAT_SEVEN_ARGUMENTS.md)
- [贾宝龙可研究本体论 2.0.0：研究邻域地图](researchable-ontology-2-0-0-research-neighborhood-map.md)
- [意识体反观 U(PR)：自洽性内部证明点](consciousness-reflects-u-pr-internal-proof-point.md)
